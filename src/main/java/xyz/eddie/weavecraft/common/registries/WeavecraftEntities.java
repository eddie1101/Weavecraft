...
public class WeavecraftEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<TriggerEntity>> TRIGGER_ENTITY = ENTITIES.register("trigger_entity", () -> EntityType.Builder.of(TriggerEntity::getTriggerEntityForRegistry, MobCategory.MISC).sized(0.01f, 0.01f).build("trigger_entity"));
